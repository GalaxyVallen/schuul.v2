...
<body>
            ...
            <table class="w-full table-auto text-sm text-left">
                <caption class="p-5 text-2xl font-display relative font-semibold isolate text-left text-gray-900 bg-white dark:text-white dark:bg-gray-800">
                    ...
                    <?php if ($datas->num_rows == 0) : ?>
                        <p class="mt-1 text-base font-normal text-gray-500 dark:text-gray-400">Belum ada siswa </p>
                    <?php else : ?>
                        <p class="mt-1 text-base font-normal text-gray-500 dark:text-gray-400">Sekitar <?= $datas->num_rows; ?> siswa </p>
                    <?php endif; ?>
                ...
                <tbody>
                    <?php $i = 1; ?>
                    <?php while ($row = $datas->fetch_object()) : ?>
                        <tr class="bg-white hover:bg-gray-50 dark:hover:bg-gray-600 border-b dark:bg-gray-800 dark:border-gray-700  dark:text-white text-gray-700">
                            ...
                            <td class="px-6 py-4 <?= Functions::getClass($row->nilai_akhir); ?>">
                                <?= $row->nilai_akhir; ?>
                            </td>
                            <td class="px-6 py-4">
                                <?= $row->result; ?>
                            ...
                            <td class="px-6 py-4 text-right">
                                <a href="page/detail.php?siswa=<?= $row->id; ?>" class="underline-none text-blue-600 hover:underline">Detail</a>
                            </td>
                        </tr>
                        <?php $i++ ?>
                    <?php endwhile; ?>
    ...
    <script>
        setTimeout(() => document.getElementById('aler').style.display = 'none', 3000);
    </script>
</body>
